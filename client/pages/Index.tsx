    ...
    <>
          ...
          <div className="py-16 md:py-24 text-center text-white">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-white/70">
                The largest, most trusted film production rental community. Find the gear you need or list yours to earn more.
              </p>
            </div>
            <div className="mt-8">
              <SearchBar />
            </div>
            <div className="mt-6 text-xs text-white/60">{exampleFromServer}</div>
          </div>
        </div>
      ...
      <section className="container py-10 md:py-14">
        <div className="flex items-center justify-between gap-4">
          <h2 className="text-xl font-semibold md:text-2xl">Browse categories</h2>
          <Button variant="ghost" className="hidden md:inline-flex">View all</Button>
        </div>
        <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-6">
          {categories.map((c) => (
            <Card key={c.name} className="group border-0 bg-gradient-to-br from-zinc-50 to-white shadow hover:shadow-md dark:from-zinc-900 dark:to-zinc-900">
      ...
      <section className="container py-10">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold md:text-2xl">Popular products for rent</h2>
          <Button variant="ghost" className="hidden md:inline-flex">See more</Button>
        </div>
      ...
      <section className="border-y bg-muted/30 py-14">
        <div className="container grid items-center gap-10 md:grid-cols-2">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">A trusted community for filmmakers</h2>
            <p className="mt-3 text-muted-foreground">
              Verified users, secure payments and insurance-backed rentals keep your gear safe. Join thousands of professionals earning with Film Stock.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <Button><UsersRound className="mr-2" /> Join now</Button>
              <Button variant="outline">Learn more</Button>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {["Insurance", "ID Verification", "24/7 Support", "Secure Payments"].map((f) => (
              <Card key={f} className="bg-white/60 dark:bg-zinc-900/60">
                <CardContent className="p-5">
                  <div className="text-sm font-semibold">{f}</div>
                  <p className="mt-1 text-xs text-muted-foreground">Protection and peace of mind for every rental.</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="container py-16">
        <div className="rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-8 md:p-10">
          <div className="grid items-center gap-6 md:grid-cols-2">
            <div>
              <h3 className="text-2xl font-bold">Rent or sell your camera gear</h3>
              <p className="mt-2 text-muted-foreground">Turn idle equipment into revenue. List in minutes and get booked by local filmmakers.</p>
            </div>
